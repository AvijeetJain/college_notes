...
void myDisplay()
{
    ...
    decideSlope(1, 1, 20, 1);
    //Upper horizontal line 
    decideSlope(1, 10, 20, 10);
    //Left vertical Line
    decideSlope(1, 1 , 1, 10);
    // Upper vertical line
    decideSlope(20,10,20, 15);
    //Lower Vertical line
    decideSlope(20,1,20, -5);
    // Up to down line
    decideSlope(20,15, 30, 5 );
    // Down to up line
    decideSlope(20,-5, 30, 5 );
    glFlush();
}
int main(int argc, char **argv)
{
    ...
    glutCreateWindow("Arrow using mid Point Algorithm");
    myInit();
